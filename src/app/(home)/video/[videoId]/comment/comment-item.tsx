...
import { UserAvatar } from "@/app/(studio)/studio/components/layout/sidebar/user-avatar";
...
const CommentItem = ({
  ...
  const viewerReaction = initialComment.commentLikes.some(
    (l) => l.userId === userId
  )
    ? "like"
    : initialComment.commentDislikes.some((d) => d.userId === userId)
      ? "dislike"
      : null;
