...
export const SignInView = () => {
  ...
  return (
    <CardWrapper
      cardTitle="Connectez-vous, ou enregistrez-vous"
      cardFooterDescription="En continuant, vous acceptez notre"
      cardFooterLinkTitle="Politique de confidentialité et Conditions d'utilisation"
      cardFooterLink="/legal"
    >
        ...
        <Form {...form}>
          <form className="space-y-5" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="text-muted-foreground flex w-full items-center py-5 text-sm">
              ...
              <span className="text-primary-foreground mx-2 text-lg">ou</span>
              <div className="border-secondary-foreground flex-grow border-t" />
            </div>
